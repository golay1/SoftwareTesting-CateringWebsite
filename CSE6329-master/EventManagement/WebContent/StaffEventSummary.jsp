...
<tr>
<td></td>
<td><input name = "action" value = "viewEventS" type="hidden"></td>
...
<td><input type = button value = "Back" onclick="location.href='StaffHomePage.jsp'" ></td>
</tr>
</table>
</form>
<table>
<tr>
  ...
  <c:forEach items="${EventModelList}" var = "item" varStatus="status">
        ...
        <td> <a href="<c:url value='/EventController?action=viewSelectedEventS&id=${item.eventID}'/>">View</a></td>
  		</tr>
  </c:forEach>
</table>
</center>
