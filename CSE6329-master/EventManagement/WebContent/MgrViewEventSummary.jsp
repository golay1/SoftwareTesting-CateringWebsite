...
<tr>
<td>Event Status :</td>
<td><input type = "text" name = "event_status" value="<c:out value = '${EventModel.status}'/>" readonly></td>
</tr>
<tr>
<td>Assigned Staff FirstName :</td>
<td><input type = "text" name = "staffFirstName" value="<c:out value = '${EventModel.staffFirstName}'/>"></td>
<td><input name = "err_EstAttendees" value="<c:out value = '${EventErrorMsgs.staffFirstNameError}'/>" style ="background-color: white; border: none; width: 400px;" disabled="disabled" readonly></td>
</tr>
<tr>
<td>Assigned Staff LastName :</td>
<td><input type = "text" name = "staffLastName" value="<c:out value = '${EventModel.staffLastName}'/>"></td>
<td><input name = "err_EstAttendees" value="<c:out value = '${EventErrorMsgs.staffLastNameError}'/>" style ="background-color: white; border: none; width: 400px;" disabled="disabled" readonly></td>
</tr>
<tr>
<td>&nbsp;</td>
...
<tr>
<td></td>
<td><input type = "submit" name = "action" action = "change" value = "Change" onclick="if (confirm('Are you sure you want to change?')) form.action='EventController?action=change';else return false;"></td>
<td><input type = "submit" name = "action" action = "assign" value = "Assign"></td>
...
<td><input type = button value = "Back" onclick="location.href='ManagerEventSummary.jsp'" ></td>
</tr>
</table>
</form>
</center>
