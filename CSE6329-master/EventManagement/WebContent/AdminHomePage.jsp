...
<form method = "post" action = "UserController">
<tr>
<td><input type = button value = "User Search" onclick="location.href='UserSearch.jsp'" style="width: 175px; margin: 0 auto;" ></td>
<%-- <td><button type = "submit" style="width: 175px; margin: 0 auto;">Search User</td>
